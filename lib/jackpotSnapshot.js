...
async function fetchJackpotTotalsFromDB() {
  ...
  jackpots = {
    joinersTotal: fetchedJackpots.joinersTotal * 0.7 * 1000,
    weeklyTotal: fetchedJackpots.weeklyTotal * 0.7 * 1000,
    monthlyTotal: fetchedJackpots.monthlyTotal * 0.7 * 1000,
    annualTotal: fetchedJackpots.annualTotal * 0.7 * 1000,
  };
}
