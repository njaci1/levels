  ...
  try {
    ...
    if (inviter) {
      ...
      const notification = new Notification({
        ...
        message: `Ka-ching'! You have earned Ksh.${Math.floor(
          commissionAmount * level1Rate
        )} commission from your Level1 network! Keep inviting friends to increase your earnings!`,
        win: 'commission',
      });
    ...
    if (inviter.inviter?.inviter) {
      ...
      const notification = new Notification({
        ...
        message: `Ka-ching'! You have earned Ksh.${Math.floor(
          commissionAmount * level2Rate
        )} commission from your Level2 network! Keep inviting friends to increase your earnings!`,
        win: 'commission',
      });
    ...
    if (inviter.inviter?.inviter?.inviter) {
      ...
      const notification = new Notification({
        ...
        message: `Ka-ching'! You have earned Ksh.${Math.floor(
          commissionAmount * level3Rate
        )} commission from your Level3 network! Keep inviting friends to increase your earnings!`,
        win: 'commission',
      });
